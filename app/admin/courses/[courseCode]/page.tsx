...
import { GuestCourseDistribution } from "@/components/admin/guest-course-distribution";
import { BookOpen, Sparkles, Settings, ChevronDown, ChevronUp, Share2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="basic" className="w-full">
        ...
        {/* Tab 4: Microsite Distribution */}
        <TabsContent value="distribution" className="mt-6">
          <GuestCourseDistribution
            courseId={courseId}
            institutions={institutions}
            ownerInstitutionId={course.institutionId || null}
          />
        </TabsContent>
      </Tabs>
    </div>
