...
export default function InstitutionNewsDetailPage() {
    ...
    useEffect(() => {
        async function loadData() {
            ...
            try {
                const newsRes = await fetch(`/api/news/${newsId}`).then(r => r.json());
    ...
    if (!news) {
        return (
            <div className="container mx-auto px-4 py-16 text-center">
                ...
                <Button asChild>
                    <Link href={`/institutions/${params.id}/news`}>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
                        ...
                        <div className="mt-8 pt-8 border-t">
                            <SocialShare
                                url={`/institutions/${params.id}/news/${news.id}`}
                                title={news.title}
