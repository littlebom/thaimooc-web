...
// Fetch guide by ID — does NOT increment view_count (public page handles that separately)
async function getGuide(id: string) {
  try {
    ...
    // Increment view count for public visitors
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                  <span className="flex items-center gap-1">
                    ...
                    อัพเดทล่าสุด:{" "}
                    {new Date(guide.updated_at).toLocaleDateString("th-TH", {
                      year: "numeric",
                      month: "long",
                      day: "numeric",
                    })}
              ...
              <div className="grid grid-cols-1 gap-3">
                {relatedGuides.map(
                  (relatedGuide: {
                    ...
                    <Link
                      key={relatedGuide.id}
                      href={`/support/guides/${relatedGuide.id}`}
                    >
