...
export function ChatbotWidget() {
  ...
  useEffect(() => {
    const savedUserInfo = localStorage.getItem("thaimooc_chatbot_user");
    if (savedUserInfo) {
      try {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      ...
      if (!userInfo) {
        ...
        setMessages([{
          id: "welcome",
          text: `สวัสดีครับคุณ${userInfo.name}! ผมคือ Thai MOOC Assistant พร้อมช่วยตอบคำถามเกี่ยวกับคอร์สเรียนและการใช้งานระบบครับ`,
          sender: "ai",
          timestamp: new Date(),
        }]);
      }
  ...
  const handleWelcomeSubmit = () => {
    ...
    localStorage.setItem("thaimooc_chatbot_user", JSON.stringify(newUserInfo));
    ...
    setMessages([{
      id: "welcome",
      text: `สวัสดีครับคุณ${newUserInfo.name}! ผมคือ Thai MOOC Assistant พร้อมช่วยตอบคำถามเกี่ยวกับคอร์สเรียนและการใช้งานระบบครับ`,
      sender: "ai",
      timestamp: new Date(),
    }]);
        ...
        <Card className="fixed bottom-6 right-6 z-50 w-96 h-[500px] shadow-2xl flex flex-col">
          <div className="bg-blue-600 text-white p-4 rounded-t-lg flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-semibold text-base">Thai MOOC Assistant</h3>
