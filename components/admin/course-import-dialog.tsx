        ...
        <div className="space-y-4 py-4">
          ...
          <div className="bg-muted p-4 rounded-md">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground list-disc list-inside">
              <li>ไฟล์ CSV ต้องมี header ตรงกับตัวอย่าง (21 คอลัมน์)</li>
              <li>
